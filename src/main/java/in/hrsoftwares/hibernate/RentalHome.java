 ...
 * @see in.hrsoftwares.hibernate.Rental
...
public class RentalHome {
	...
	public Rental findById(java.lang.Integer id) {
		...
		try {
			Rental instance = (Rental) sessionFactory.getCurrentSession().get("in.hrsoftwares.hibernate.Rental", id);
			if (instance == null) {
	...
	public List<Rental> findByExample(Rental instance) {
		...
		try {
			List<Rental> results = (List<Rental>) sessionFactory.getCurrentSession()
					.createCriteria("in.hrsoftwares.hibernate.Rental").add(create(instance)).list();
