 ...
 * @see in.hrsoftwares.hibernate.Customer
...
public class CustomerHome {
	...
	public Customer findById(java.lang.Short id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession().get("in.hrsoftwares.hibernate.Customer",
					id);
			if (instance == null) {
	...
	public List<Customer> findByExample(Customer instance) {
		...
		try {
			List<Customer> results = (List<Customer>) sessionFactory.getCurrentSession()
					.createCriteria("in.hrsoftwares.hibernate.Customer").add(create(instance)).list();
