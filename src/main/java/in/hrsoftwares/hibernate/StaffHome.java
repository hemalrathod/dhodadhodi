 ...
 * @see in.hrsoftwares.hibernate.Staff
...
public class StaffHome {
	...
	public Staff findById(java.lang.Byte id) {
		...
		try {
			Staff instance = (Staff) sessionFactory.getCurrentSession().get("in.hrsoftwares.hibernate.Staff", id);
			if (instance == null) {
	...
	public List<Staff> findByExample(Staff instance) {
		...
		try {
			List<Staff> results = (List<Staff>) sessionFactory.getCurrentSession()
					.createCriteria("in.hrsoftwares.hibernate.Staff").add(create(instance)).list();
